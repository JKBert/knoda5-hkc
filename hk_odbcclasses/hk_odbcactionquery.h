...
// ****************************************************************************
#ifndef HK_ODBCACTIONQUERY
#define HK_ODBCACTIONQUERY
#include <hk_actionquery.h>
class hk_odbcdatabase;
class hk_odbcactionquery:public hk_actionquery
{
