...
hk_xbaseconnection::hk_xbaseconnection(hk_drivermanager* c):hk_connection(c)
{
#ifdef HK_DEBUG
    hkdebug("hk_xbaseconnection::hk_xbaseconnection");
#endif
...
hk_xbaseconnection::~hk_xbaseconnection()
{
#ifdef HK_DEBUG
    hkdebug("hk_xbaseconnection::~hk_xbaseconnection");
#endif
...
bool hk_xbaseconnection::server_supports(support_enum t) const
{
    switch (t)
    {
...
hk_string hk_xbaseconnection::drivername(void) const
{
...
bool hk_xbaseconnection::server_needs(need_enum t) const
{
    switch (t)
    {
//         case NEEDS_NOTHING:
...
bool  hk_xbaseconnection::driver_specific_connect()
{
#ifdef HK_DEBUG
    hkdebug("hk_xbaseconnection::driver_specific_connect");
#endif
p_connected=true;
return true;
}
...
bool hk_xbaseconnection::driver_specific_disconnect()

{
#ifdef HK_DEBUG
    hkdebug("hk_xbaseconnection::driver_specific_disconnect");
#endif
return true;
...
hk_database* hk_xbaseconnection::driver_specific_new_database(void)
{
    hk_xbasedatabase* db;
    db = new hk_xbasedatabase(this);
    return db;
}



vector<hk_string>* hk_xbaseconnection::driver_specific_dblist(void)
{
#ifdef HK_DEBUG
    hkdebug("hk_xbaseconnection::driver_specific_dblist");
#endif
    DIR *dp;
    struct dirent *entry;
...
bool    hk_xbaseconnection::create_database(const hk_string& dbase)
{
...
bool    hk_xbaseconnection::delete_database(const hk_string& dbase,enum_interaction c)
{
...
// unsigned int hk_xbaseconnection::maxfieldnamesize(void) const
// {
// return 10;
// }
...
{
    return new hk_xbaseconnection(cl);
}
