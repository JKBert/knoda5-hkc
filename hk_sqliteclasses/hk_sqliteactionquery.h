...
// ****************************************************************************
#ifndef HK_SQLITEACTIONQUERY
#define HK_SQLITEACTIONQUERY
#include <hk_actionquery.h>
class hk_sqlitedatabase;
class hk_sqliteactionquery:public hk_actionquery
{
