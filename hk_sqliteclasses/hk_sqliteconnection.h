...
// ****************************************************************************
#ifndef HK_SQLITECONNECTION
#define HK_SQLITECONNECTION
...
class hk_sqliteconnection: public hk_connection
{
    public:
        hk_sqliteconnection(hk_drivermanager* c);
        ~hk_sqliteconnection();
...
virtual hk_string mimetype(void) const {return "application/x-sqlite2";}
